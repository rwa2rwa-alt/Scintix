...
const T = {
  ar: {
    ...
    'wasalt.badge':     'لأول مرة',
    'wasalt.title':     '«وصلت» — أمان أكثر عند خروج الأطفال',
    'wasalt.body':      'نظام ذكي مخصص للروضات والمدارس ينظم طلبات دخول وخروج الأطفال عبر واتساب، ويخفف التأخير والازدحام ويمنح الوالدين طمأنينة أكبر.',
    'wasalt.point1':    'بدون تطبيق جديد',
    'wasalt.point2':    'لوحة متابعة للمدرسة',
    'wasalt.point3':    'تفعيل للخروج أو للدخول والخروج',
    'wasalt.cta':       'اكتشف نظام وصلت',
    'wasalt.chat':      '👋 مرحبًا بك في وصلت<br>كيف يمكننا مساعدتك؟',
    'wasalt.request':   '🚗 طلب خروج طفل',
    'wasalt.track':     '📋 متابعة الطلب',
    ...
    'features.wasalt.title':'وصلت — أمان خروج الأطفال',
    'features.wasalt.body':'نظام ذكي للروضات والمدارس ينظم طلبات دخول وخروج الأطفال عبر واتساب.',
    'features.wasalt.cta':'اكتشف النظام ←',
    ...
    'plans.spark.six':   'اختيار ثيم جاهز وتخصيصه بهويتك',
    ...
    'offer.title': 'عرض اليوم الوطني 96',
    'offer.until': 'أسعار خاصة للعقود الجديدة حتى 1 أكتوبر 2026',
    'plans.from': 'يبدأ من',
    ...
    'portfolio.title':  'ثيمات جاهزة للانطلاق',
    'portfolio.description': 'اختر تصميمًا جاهزًا ونخصصه باسمك وألوانك ومحتواك ضمن باقة Spark — اضغط لمعاينة أي ثيم.',
    'themes.auto.title':'ثيم معرض السيارات','themes.auto.body':'تصميم داكن فاخر لعرض السيارات والخدمات ووسائل التواصل',
    'themes.beauty.title':'ثيم الصالون والجمال','themes.beauty.body':'تصميم أنيق وناعم لعرض الخدمات والأسعار والحجز',
    'themes.creative.title':'ثيم المعرض الإبداعي','themes.creative.body':'واجهة بصرية راقية للفنانين والمصورين وأصحاب الأعمال',
    'themes.retail.title':'ثيم المتجر المحلي','themes.retail.body':'تصميم عملي للمتاجر والأسواق لعرض الأقسام والعروض',
    'themes.all':'استعرض جميع الثيمات الجاهزة',
  ...
  en: {
    ...
    'wasalt.badge':     'For the first time',
    'wasalt.title':     'Wasalt — Safer student dismissal',
    'wasalt.body':      'A smart system for kindergartens and schools that organizes student arrival and dismissal through WhatsApp, reduces delays and congestion, and gives parents greater peace of mind.',
    'wasalt.point1':    'No new app required',
    'wasalt.point2':    'School monitoring dashboard',
    'wasalt.point3':    'Dismissal only or arrival and dismissal',
    'wasalt.cta':       'Discover Wasalt',
    'wasalt.chat':      '👋 Welcome to Wasalt<br>How can we help?',
    'wasalt.request':   '🚗 Request student dismissal',
    'wasalt.track':     '📋 Track request',
    ...
    'features.wasalt.title':'Wasalt — Safer student dismissal',
    'features.wasalt.body':'A smart system for kindergartens and schools that organizes student arrival and dismissal requests through WhatsApp.',
    'features.wasalt.cta':'Discover Wasalt →',
    ...
    'plans.spark.six':   'Choose a ready theme customized to your brand',
    ...
    'offer.title': 'Saudi National Day 96 Offer',
    'offer.until': 'Special pricing for new contracts through October 1, 2026',
    'plans.from': 'Starting from',
    ...
    'portfolio.title':  'Ready-to-launch themes',
    'portfolio.description': 'Choose a ready-made design and we will customize it with your name, colors, and content as part of the Spark package. Click any theme to preview it.',
    'themes.auto.title':'Automotive showroom theme','themes.auto.body':'A premium dark design for vehicles, services, and contact details',
    'themes.beauty.title':'Salon and beauty theme','themes.beauty.body':'An elegant, soft design for services, prices, and booking',
    'themes.creative.title':'Creative portfolio theme','themes.creative.body':'A refined visual interface for artists, photographers, and creators',
    'themes.retail.title':'Local store theme','themes.retail.body':'A practical design for stores and markets to showcase departments and offers',
    'themes.all':'Browse all ready themes',
