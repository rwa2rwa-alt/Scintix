...
const T = {
  ar: {
    ...
    'faq.description':  'إجابات سريعة تساعدك تختارين الباقة الصح',
    ...
    'faq.switch.a': 'بالتأكيد، تقدرين تترقّين لباقة أعلى في أي وقت، ونحسب الفرق بشكل عادل حسب المدة المتبقية من اشتراكك الحالي.'
  },
  en: {
